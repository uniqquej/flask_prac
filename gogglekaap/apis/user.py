...
'''프론트에 노출시켜 줄 모델 설정 (marshal)'''
user = ns.model('User',{
    'id': fields.Integer(required=True, description='유저 고유 번호'),
    'user_id': fields.String(required=True, description='유저 고유 아이디'),
...
#/api/users
@ns.route('')
@ns.response(409, 'User Id is already exists') #문서 자동화
